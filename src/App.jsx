...
function App() {
  ...
  function handleSend() {
    ...
    if (
      ...
      parentPhone.trim().length !== 11 ||
      !phone.trim().startsWith("01") ||
      !parentPhone.trim().startsWith("01") ||
      isNaN(phone) ||
      isNaN(parentPhone)
    ) {
      setTimeout(() => {
    ...
    if (
      phone.trim() === "01145335636" ||
      parentPhone.trim() === "01145335636"
    ) {
      setTimeout(() => {
        setError(
          "This phone number is our contact number, please enter a different one",
        );
        setTimeout(() => {
          setError("");
        }, 5000);
                  ...
                  <>
                    ...
                    <div className="option">
                      <p className="disables">
                        Thursday (2:30 PM) <span>Completed</span>
                      </p>
                      <p
                        onClick={() => {
                          setsubmit(true);
              ...
              >
                ...
                {grade === "prep2" && (
                  <>
                    ...
                    <div className="option">
                      <p className="disables">
                        Sunday (4:30 PM)<span>Completed</span>
                      </p>
                      <p className="disables">
              ...
              >
                ...
                {grade === "prep3" && (
                  <>
                    ...
                    <div className="option">
                      <p className="disables">
                        Sunday (2:30 PM)<span>Completed</span>
                      </p>
                      <p className="disables">
                        Wednesday (2:30 PM)<span>Completed</span>
                      </p>
                      <p className="disables">
                        Thursday (4:30 PM)<span>Completed</span>
                      </p>
                    </div>
                  </>
                )}
