            ...
            <section className="sec" onClick={()=> setgrade("")}>
              ...
              <div className="div" onClick={(e)=> {e.stopPropagation();setgrade("prep2")}}>
                ...
                {grade === "prep2" && <>
                  <p>Choose your group:</p>
                  <div className="option">
                    <p className='disables'>Sunday (4:30 PM)<span>Completed</span></p>
                    <p className='disables'>Tuesday (4:30 PM)<span>Completed</span></p>
              ...
              <div className="div" onClick={(e)=> {e.stopPropagation();setgrade("prep3")}}>
                ...
                {grade === "prep3" && <>
                  <p>Choose your group:</p>
                  <div className="option">
                    <p className='disables'>Sunday (2:30 PM)<span>Completed</span></p>
